...
var users = {
	phineas: {
		...
		avatar: 'https://cdn.discordapp.com/attachments/917110933510303764/988770392560787486/a_f770ca58fcfd91ba270a711c650585e8.gif'
	},
	paragon: {
		username: '𝐉𝐮𝐬𝐭 𝐌𝐮𝐬𝐢𝐜',
		nameColor: 'hsl(212, 51%, 59%)',
		bot: true,
		avatar: 'https://cdn.discordapp.com/attachments/983952270158880768/988781457143107604/images.png'
	}
};
...
var channelData = [{
	...
	messages: [{
		...
		embedData: {
			title: '-=-=-=-=-= Help =-=-=-=-=-',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://cdn.dribbble.com/users/857299/screenshots/6576777/ezgif.com-video-to-gif.gif?width=120&height=120',
			fields: [{
				name: '+jfilter',
				value: 'songs filters'
			}, {
				name: '+jjoin',
				value: 'join the channel 24/7'
			}, {
				name: '+jjump',
				value: 'skip a specific song'
			}, {
				name: '+jleave',
				value: 'leave the voice channel'
			}, {
				name: '+jloop',
				value: 'repeat the song/queue'
			}, {
				name: '+jlyrics',
				value: 'view the song lyrics'
			}, {
				name: '+jnowplaying',
				value: 'view what is playing now'
			}, {
				name: '+jpause',
				value: 'pause the queue'
			}, {
				name: '+jping',
				value: 'view the bot ping'
			}, {
				name: '+jplay',
				value: 'play a music/playlist'
			}, {
				name: '+jprefix',
				value: 'change the prefix in you guild'
			}, {
				name: '+jqueue',
				value: 'view the server queue'
			}, {
				name: '+jradio',
				value: 'play a random music'
			}, {
				name: '+jresume',
				value: 'resume the server queue'
			}, {
				name: '+jsay',
				...
				name: '+jstop',
				value: 'stop the server queue'
			}, {
				name: '+jvolume',
				value: 'change the songs volume'
